...
# ==================== (w861_junk_first 已随 junk_first 开关族删除) ====================
# (变宝为废牺牲合成排序锁段已随 junk_first_sacrifice_enabled 开关族删除
#  ——旧方案清退批,清查报告 OLD_MIX_AUDIT §1.3;kernel/cw_junk_first.py
#  模块与 session.junk_first_done_plane 同批删。)
