...
# ==================== (w880_equip_env fill3/junk_first 锁段已随开关族删除) ====================
# (fill-to-3 量变体与变宝为废序变体锁段已随 equip_env_fill3_enabled /
#  junk_first_sacrifice_enabled 开关族删除——旧方案清退批,清查报告
#  OLD_MIX_AUDIT §1.3;仅保留生锈豁免门锁(消费 signals 单源)。
#  apply_equip_env_variants 退化为基分配直通。)

from types import SimpleNamespace as _w880_equip_env_SimpleNamespace

from sr_od.application.currency_war.kernel.cw_equip_env import  build_equip_env_signals
