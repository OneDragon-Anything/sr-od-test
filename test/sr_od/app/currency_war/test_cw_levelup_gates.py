...
# ==================== (w373_c3c4_redesign 已随 C4 开关族删除) ====================
# (C4 投影/门/两态锁段已随 line_switch_survival_gate_enabled 与
#  rounds_two_state_enabled 开关族删除——旧方案清退批,清查报告
#  OLD_MIX_AUDIT §1.3;rounds_alive/survival_gate/register_gate_block
#  同批删。损血表 p2_node_loss_table/p2_cond_loss_table 与 p_win 表
#  保留,结构锁由 test_cw_adr0293_calibration 面册承载。)
