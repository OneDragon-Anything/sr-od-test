...
def test_sampler_v4_and_snapshot_selfconsistent() -> None:
    """采样器版本(ADR-0308 起 v6;本锁语义=版本入指纹+快照自洽)。"""
    assert cw_sim._SAMPLER_VERSION == 6
    ...
    assert cw_delta_pool_data.META['sampler_version'] == 6
    # 池语义变更使指纹与旧版快照(d891233d/066c4185/886f8a39)可区分
